...
class ChatWindow:
    ...
    def __init__(self):
        ...
        self._master.title("Internet relay Chat Application")
    ...
    #HOW MANY OTHER ROOMS ARE ACTIVE, THAT WILL BE SHOWN ON THE WINDOW
